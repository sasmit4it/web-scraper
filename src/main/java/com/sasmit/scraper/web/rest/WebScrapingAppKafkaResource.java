...
@RestController
@RequestMapping("/api/web-scraping-app-kafka")
public class WebScrapingAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WebScrapingAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WebScrapingAppKafkaResource(KafkaProperties kafkaProperties) {
