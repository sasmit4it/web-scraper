package com.sasmit.scraper.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("WebScrapingApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("WebScrapingApp");
        ...
        config.getMapConfigs().put("com.sasmit.scraper.domain.*", initializeDomainMapConfig(jHipsterProperties));
